...
{
    public partial class InvoiceCenterConfig : UserControl
    {
        public InvoiceCenterConfig()
        {
            InitializeComponent();
        }
        ...
        {
            B2BInvoiceTransferManager.SetRetry();
        ...
        {
            FailedInvoiceInfo.Text = B2BInvoiceTransferManager.ReportError();
