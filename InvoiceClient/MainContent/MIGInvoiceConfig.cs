...
{
    public partial class MIGInvoiceConfig : UserControl , ITabWorkItem
    {
        private ITransferManager _transferMgr;

        public MIGInvoiceConfig()
        {
            InitializeComponent();
            _transferMgr = InvoiceClientTransferManager.GetTransferManagerForCurrentUI(typeof(MIGInvoiceConfig));
        }
