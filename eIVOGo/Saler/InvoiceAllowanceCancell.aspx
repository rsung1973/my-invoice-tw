...
<%@ Register src="../Module/EIVO/InvoiceAllowanceCancell.ascx" tagname="InvoiceAllowanceCancell" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <uc1:InvoiceAllowanceCancell ID="InvoiceAllowanceCancell1" runat="server" />
</asp:Content>
