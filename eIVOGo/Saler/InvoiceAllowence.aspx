...
<%@ Register src="../Module/EIVO/InvoiceAllowanceCreate.ascx" tagname="InvoiceAllowanceCreate" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <uc1:InvoiceAllowanceCreate ID="InvoiceAllowanceCreate1" runat="server" />
</asp:Content>
