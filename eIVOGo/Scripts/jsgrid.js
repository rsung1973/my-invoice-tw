...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        //added by rsung
        footing: true,
        footerRowRenderer: null,
        footerRowClass: "jsgrid-footer-row",
        //
        ...
        gridFooterClass: "jsgrid-grid-footer",
        ...
        _createFooter: function () {
            var $footerRow = this._footerRow = this._createFooterRow();

            var $footerGrid = this._footerGrid = $("<table>").addClass(this.tableClass)
                .append($footerRow);

            var $footer = this._footer = $("<div>").addClass(this.gridFooterClass)
                .addClass(this._scrollBarWidth() ? "jsgrid-footer-scrollbar" : "")
                .append($footerGrid);
        ...
        _createBody: function() {
            ...
            var $body = this._body = $("<div>").addClass(this.gridBodyClass)
                ...
                .on("scroll", $.proxy(function(e) {
                    ...
                    this._footer.scrollLeft(e.target.scrollLeft);
                }, this));
        ...
        _createFooterRow: function () {
            if ($.isFunction(this.footerRowRenderer)) {
                return $(this.footerRowRenderer());
            }

            var $result = $("<tr>").addClass(this.footerRowClass);

            this._eachField(function (field, index) {
                var $th = $("<th>").addClass(field.footercss || field.css)
                    .appendTo($result)
                    .append(field.footerTemplate ? field.footerTemplate() : "")
                    .css("width", field.width);
        ...
        _refreshFooting: function () {
            this._footerRow.toggle(this.footing);
        },
