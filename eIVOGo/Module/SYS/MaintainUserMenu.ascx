...
<%@ Register src="UserMenuList.ascx" tagname="UserMenuList" tagprefix="uc3" %>



<uc1:PageAction ID="actionItem" runat="server" ItemName="首頁 &gt; 系統維護" />
<uc2:FunctionTitleBar ID="titleBar" runat="server" ItemName="工作選單套用維護" />
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <uc3:UserMenuList ID="UserMenuList1" runat="server" />
    </ContentTemplate>
</asp:UpdatePanel>
