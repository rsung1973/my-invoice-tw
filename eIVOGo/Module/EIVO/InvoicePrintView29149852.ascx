...
<%@ Register Src="Item/InvoiceReceiptView29149852.ascx" TagName="InvoiceReceiptView"
    TagPrefix="uc2" %>
<%@ Register Src="Item/InvoiceBalanceView29149852.ascx" TagName="InvoiceBalanceView"
    TagPrefix="uc3" %>
<%@ Register Assembly="Model" Namespace="Model.DataEntity" TagPrefix="cc1" %>
<div class="fspace">
    <div class="company">
        <span class="title">群揚資通有限公司</span><br />
        <p>
            25164新北市淡水區新民街152巷6弄21號<br />
