<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InvoiceAllowanceSellerGroupList.ascx.cs"
    Inherits="eIVOGo.Module.EIVO.InvoiceAllowanceSellerGroupList" %>
...
<asp:GridView ID="gvEntity" runat="server" EnableViewState="False" CssClass="table01"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="電子折讓單張數" SortExpression="TotalCount">
            <ItemTemplate>
                <%# Eval("TotalCount") %>
            </ItemTemplate>
