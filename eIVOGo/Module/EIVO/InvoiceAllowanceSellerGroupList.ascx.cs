...
{
    public partial class InvoiceAllowanceSellerGroupList : InvoiceItemSellerGroupList 
    {
        ...
        protected override void buildQueryItem()
        {
            ...
            if (DateFrom.HasValue)
                queryExpr = queryExpr.And(i => i.AllowanceDate >= DateFrom);
            if (DateTo.HasValue)
                queryExpr = queryExpr.And(i => i.AllowanceDate < DateTo.Value.AddDays(1));
