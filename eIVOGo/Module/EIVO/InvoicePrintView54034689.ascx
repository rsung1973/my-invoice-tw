...
<%@ Register Src="Item/InvoiceReceiptView54034689.ascx" TagName="InvoiceReceiptView"
    TagPrefix="uc2" %>
<%@ Register Src="Item/InvoiceBalanceView54034689.ascx" TagName="InvoiceBalanceView"
    TagPrefix="uc3" %>
<%@ Register Assembly="Model" Namespace="Model.DataEntity" TagPrefix="cc1" %>
<div class="fspace">
    <div class="company">
        <span class="title">木森股份有限公司</span><br />
        <p>
            新北市泰山區台麗街16巷1號1樓<br />
