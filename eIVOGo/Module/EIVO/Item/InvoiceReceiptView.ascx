<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InvoiceReceiptView.ascx.cs"
    Inherits="eIVOGo.Module.EIVO.Item.InvoiceReceiptView" %>
                        ...
                        <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="table-Khaki"
                            ...
                            <tr>
                                <td height="105" align="center" style="border-bottom-width: 0px; border-right-width: 0px;">
                                    <img id="sealImg" runat="server" src="~/Seal/Google.jpg" width="115" height="100" />
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table width="100%" border="0" cellpadding="1" cellspacing="0">
                ...
                <tr>
                    <td>
                        ...
                        本發票依<%# String.IsNullOrEmpty(_item.Organization.OrganizationStatus.AuthorizationNo) ? "臺北市國稅局信義分局100年7月25日財北國稅信義營業字第1000213447號" : _item.Organization.OrganizationStatus.AuthorizationNo %>函核准使用。<br />
                        買受人註記欄之註記方法：<br />
