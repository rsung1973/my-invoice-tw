...
<asp:Repeater ID="rpList" runat="server" EnableViewState="false">
    <ItemTemplate>
        <div class="content_box">
            <p class="productname"><%# Item.Brief%></p>
            <p class="quantity"><%# String.Format("{0:##,###,###,###}", ((InvoiceProductItem)Container.DataItem).Piece)%></p>
            <p class="price"><%# String.Format("{0:##,###,###,###}", ((InvoiceProductItem)Container.DataItem).UnitCost) %></p>
            <p class="totalPrice"><%# String.Format("{0:##,###,###,###}", ((InvoiceProductItem)Container.DataItem).CostAmount)%></p>
        </div>
    </ItemTemplate>
</asp:Repeater>
