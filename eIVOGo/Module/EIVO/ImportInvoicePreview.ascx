<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImportInvoicePreview.ascx.cs"
    Inherits="eIVOGo.Module.EIVO.ImportInvoicePreview" %>
...
<uc6:PageAnchor ID="PrevAction" runat="server" RedirectTo="~/EIVO/Invoice_File_Import.aspx" />
