<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImportAllowanceCancellationPreview.ascx.cs"
    Inherits="eIVOGo.Module.EIVO.ImportAllowanceCancellationPreview" %>
...
<uc6:PageAnchor ID="NextAction" runat="server" RedirectTo="~/EIVO/AllowanceCancellationUploadList.aspx" />
<uc6:PageAnchor ID="PrevAction" runat="server" RedirectTo="~/EIVO/InvoiceAllowanceCancellationImport.aspx" />
