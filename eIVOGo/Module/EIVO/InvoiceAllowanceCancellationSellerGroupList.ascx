<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InvoiceAllowanceCancellationSellerGroupList.ascx.cs"
    Inherits="eIVOGo.Module.EIVO.InvoiceAllowanceCancellationSellerGroupList" %>
...
<asp:GridView ID="gvEntity" runat="server" EnableViewState="False" CssClass="table01"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="作廢電子折讓單張數" SortExpression="TotalCount">
            <ItemTemplate>
                <%# Eval("TotalCount") %>
            </ItemTemplate>
