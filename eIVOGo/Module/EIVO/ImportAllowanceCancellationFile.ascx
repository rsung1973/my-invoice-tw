...
<uc1:PageAction ID="actionItem" runat="server" ItemName="首頁 &gt; 作廢折讓證明單匯入" />
<!--交易畫面標題-->
<uc4:FunctionTitleBar ID="titleBar" runat="server" ItemName="作廢折讓證明單匯入" />
<div class="border_gray">
    <!--表格 開始-->
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_title">
        <tr>
            <th width="150" nowrap="nowrap">
                <span class="red">*</span> 作廢折讓證明單匯入
            </th>
            <td class="tdleft">
                &nbsp;
...
<uc5:PageAnchor ID="NextAction" runat="server" RedirectTo="~/EIVO/AllowanceCancellationUploadPreview.aspx" />
<script runat="server">
    protected override Model.InvoiceManagement.IGoogleUploadManager createUploadManager()
    {
        return new Model.InvoiceManagement.GoogleAllowanceCancellationUploadManager();
    }
</script>