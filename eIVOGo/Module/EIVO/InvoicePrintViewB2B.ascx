<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InvoicePrintViewB2B.ascx.cs" Inherits="eIVOGo.Module.EIVO.InvoicePrintViewB2B" %>
<%@ Register Src="~/Module/EIVO/Item/InvoiceProductPrintView.ascx" TagName="InvoiceProductPrintView"
    TagPrefix="uc1" %>
<%@ Import Namespace="Model.DataEntity" %>
<%@ Register Src="~/Module/EIVO/Item/InvoiceReceiptView.ascx" TagName="InvoiceReceiptView" TagPrefix="uc2" %>
<%@ Register Src="~/Module/EIVO/Item/InvoiceBalanceView.ascx" TagName="InvoiceBalanceView" TagPrefix="uc3" %>
