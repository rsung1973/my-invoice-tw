...
<%@ Register Src="~/Module/Inquiry/InquiryItem/InquireDonation.ascx" TagPrefix="uc4" TagName="InquireDonation" %>
<%@ Register Src="~/Module/Inquiry/InquiryItem/InquireInvoiceTaxType.ascx" TagPrefix="uc4" TagName="InquireInvoiceTaxType" %>
...
<!--交易畫面標題-->
<uc6:FunctionTitleBar ID="functionTitle" runat="server" ItemName="查詢發票" />
<div class="border_gray">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_title">
        ...
        <asp:PlaceHolder ID="inquiryHolder" runat="server">
            <uc4:InquireInvoiceTaxType runat="server" id="InquireInvoiceTaxType" />
            ...
            <uc4:InquireSMSNotification runat="server" ID="inquireSMS" />
            <uc4:InquireDonation runat="server" ID="inquireDonation" />
        </asp:PlaceHolder>
    </table>
    <!--表格 結束-->
</div>
