<%@ Control Language="C#" AutoEventWireup="true" Inherits="eIVOGo.Module.JsGrid.InquireAllowance" %>
...
<!--交易畫面標題-->
<uc6:FunctionTitleBar ID="resultTitle" runat="server" ItemName="查詢作廢折讓" />
