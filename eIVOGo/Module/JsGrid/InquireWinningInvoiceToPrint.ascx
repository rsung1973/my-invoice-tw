...
<%@ Register Src="~/Module/Common/DoDwnAddrHandler.ascx" TagPrefix="uc4" TagName="DoDwnAddrHandler" %>
...
<table id="tblAction" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td class="Bargain_btn">
            ...
            &nbsp;&nbsp;
            <uc4:DoDwnAddrHandler ID="doDwnAddr" runat="server" />
        </td>
    </tr>
</table>
<%     } 
...
<script runat="server">
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        doDwnAddr.DoAction = arg =>
        {
            this.buildQueryItem();
            Response.CsvDownload(itemList.GetCsv4BuyerAddrResult(itemList.Select().ToList()), null, Encoding.GetEncoding(950), "text/csv");
        };
