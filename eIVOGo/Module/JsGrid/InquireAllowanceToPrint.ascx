...
<%@ Register Src="~/Module/JsGrid/InvoiceAllowanceCheckList.ascx" TagPrefix="uc4" TagName="InvoiceAllowanceCheckList" %>
...
<script runat="server">
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        {
            ((ASP.module_common_doprinthandler_ascx)doPrint).DoPrintAllowance();
        };
