...
namespace eIVOGo.Module.JsGrid
{
    ...
    public partial class InquireAllowanceTemplate : InquireEntity
    {
        ...
        public IQueryable<InvoiceAllowance> BuildDefaultQuery(EIVOEntityDataContext context, IQueryable<InvoiceAllowance> items)
        {
