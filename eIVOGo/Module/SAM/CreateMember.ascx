<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreateMember.ascx.cs"
    Inherits="eIVOGo.Module.SAM.CreateMember" %>
...
<asp:UpdatePanel ID="Updatepanel1" runat="server">
    <ContentTemplate>
        <div id="mainpage" runat="server">
            <uc3:PageAction ID="actionItem" runat="server" ItemName="會員管理-新增帳號" />
            <!--交易畫面標題-->
            <h1>
                <img id="img4" runat="server" enableviewstate="false" src="~/images/icon_search.gif"
                    width="29" height="28" border="0" align="absmiddle" />會員管理-新增帳號</h1>
