<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShowTimeModal.ascx.cs"
    Inherits="eIVOGo.Module.SAM.ShowTimeModal" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="~/Module/UI/FunctionTitleBar.ascx" TagName="FunctionTitleBar" TagPrefix="uc1" %>
<%@ Register src="ShowTimeModal2.ascx" tagname="ShowTimeModal2" tagprefix="uc2" %>
                    ...
                    <tr>
                        <td class="Bargain_btn" align="center">
                            <span class="table-title">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="btnModal" runat="server" Text="NewModal" 
...
<uc2:ShowTimeModal2 ID="modal2" runat="server" />
