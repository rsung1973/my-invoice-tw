<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QueryBonusListForSaler.ascx.cs" Inherits="eIVOGo.Module.Inquiry.QueryBonusListForSaler" %>
...
<!--交易畫面標題-->
<h1><img runat="server" enableviewstate="false" id="img4" src="~/images/icon_search.gif" width="29" height="28" border="0" align="absmiddle" />查詢/列印中獎清冊</h1>
<div id="border_gray">
<!--表格 開始-->
...
<div id="border_gray">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="table01">
    ...
    <tr class="OldLace">
      ...
      <td width="120" align="center">N/A</td>
    </tr>
    <tr>
      <td align="center">99年11-12月</td>
