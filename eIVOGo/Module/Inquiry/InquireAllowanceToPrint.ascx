...
<%@ Register Src="~/Module/Base/InvoiceAllowanceCheckList.ascx" TagPrefix="uc4" TagName="InvoiceAllowanceCheckList" %>
...
<div class="border_gray">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_title">
        ...
        <asp:PlaceHolder ID="inquiryHolder" runat="server">
            <uc4:InquireAllowanceSeller runat="server" ID="inquireSeller" QueryRequired="true" AlertMessage="請選擇公司名稱!!" />
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div class="border_gray" id="resultInfo" visible="false" enableviewstate="false" runat="server">
            ...
            <uc4:InvoiceAllowanceCheckList runat="server" ID="itemList" />
            <!--按鈕-->
        </div>
    </ContentTemplate>
    <Triggers>
