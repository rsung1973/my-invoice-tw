<%@ Control Language="C#" AutoEventWireup="true" Inherits="eIVOGo.Module.Inquiry.InquireAllowanceBasic" %>
...
<%@ Register Src="~/Module/Inquiry/InvoiceAllowanceQueryList.ascx" TagPrefix="uc4" TagName="InvoiceAllowanceQueryList" %>
...
<div class="border_gray">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_title">
        <uc8:UrlRadioDirective ID="urlGo" runat="server" DefaultName="作廢電子折讓單" />
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div class="border_gray" id="resultInfo" visible="false" enableviewstate="false" runat="server">
            ...
            <uc4:InvoiceAllowanceQueryList runat="server" ID="itemList" />
            <!--按鈕-->
        </div>
    </ContentTemplate>
    <Triggers>
...
<table id="tblAction" runat="server" visible="false" enableviewstate="false" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td class="Bargain_btn">
            <uc4:DoSaveAndPrintQueryResult runat="server" ID="doSavePrint" OutputFileName="CancelledAllowanceReport.xls" />
        </td>
    </tr>
</table>
...
<script runat="server">
    ...
    {
        base.OnInit(e);
        this.PreRender += module_inquiry_InquireAllowancetoprint_ascx_PreRender;
        ...
        _queryExpr = i => i.InvoiceAllowanceCancellation != null;
    ...
    void module_inquiry_InquireAllowancetoprint_ascx_PreRender(object sender, EventArgs e)
    {
