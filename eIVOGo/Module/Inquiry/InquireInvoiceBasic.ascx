<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceBasic.ascx.cs"
    Inherits="eIVOGo.Module.Inquiry.InquireInvoiceBasic" %>
<%@ Register Src="InvoiceItemQueryList.ascx" TagName="InvoiceItemQueryList" TagPrefix="uc4" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div class="border_gray" id="resultInfo" visible="false" enableviewstate="false" runat="server">
            <%--<uc4:InvoiceItemQueryList ID="itemList" runat="server" EnableViewState="false" Visible="false" />--%>
            <!--按鈕-->
        </div>
    </ContentTemplate>
    <Triggers>
