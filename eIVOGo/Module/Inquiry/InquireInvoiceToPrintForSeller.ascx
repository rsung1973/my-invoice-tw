...
<script runat="server">
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        ((ASP.module_inquiry_inquiryitem_urlradiodirective_ascx)urlGo).NamingDirection
            = new String[] { 
                QueryType.電子發票.ToString(), "~/SAM/PrintInvoicesForSeller.aspx",
                QueryType.電子折讓單.ToString(), "~/SAM/PrintAllowancesForSeller.aspx"};
    ...
    {
        _queryExpr = _queryExpr.And(i => i.InvoiceBuyer.ReceiptNo != "0000000000");
