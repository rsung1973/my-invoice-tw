<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BuyerOrderQueryToReturn.ascx.cs"
    Inherits="eIVOGo.Module.SCM.BuyerOrderQueryToReturn" %>
...
<%@ Register Src="View/BuyerOrderListForReturn.ascx" TagName="BuyerOrderListForReturn"
    TagPrefix="uc14" %>
<%@ Register src="../Common/ClearInputField.ascx" tagname="ClearInputField" tagprefix="uc15" %>


<!--路徑名稱-->
<uc5:PageAction ID="actionItem" runat="server" ItemName="首頁 &gt; 新增退貨單" />
<!--交易畫面標題-->
<uc6:FunctionTitleBar ID="titleBar" runat="server" ItemName="新增退貨單" />
<h2>
    訂單查詢</h2>
...
<uc14:BuyerOrderListForReturn ID="itemList" Visible="false" runat="server" />
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblNext" runat="server"
    visible="false" enableviewstate="false">
    <tr>
        <td class="Bargain_btn">
            <asp:Button ID="btnTransfer" runat="server" Text="轉入退貨單" class="btn" OnClick="btnTransfer_Click" />
        </td>
    </tr>
</table>
...
<uc13:PageAnchor ID="ToReturnGoods" runat="server" TransferTo="~/SCM/EditReturnedGoods.aspx" />
