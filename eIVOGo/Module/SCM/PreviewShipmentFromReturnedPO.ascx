<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PreviewShipmentFromReturnedPO.ascx.cs"
    Inherits="eIVOGo.Module.SCM.PreviewShipmentFromReturnedPO" %>
...
<%@ Register src="View/SingleShipmentPreviewFromReturnedPO.ascx" tagname="SingleShipmentPreviewFromReturnedPO" tagprefix="uc3" %>
<uc1:PageAction ID="actionItem" runat="server" ItemName="首頁 &gt; 出貨單預覽" />
<uc2:FunctionTitleBar ID="titleBar" runat="server" ItemName="出貨單預覽" />
<uc3:SingleShipmentPreviewFromReturnedPO ID="shipment" runat="server" />
...
<uc6:PageAnchor ID="ToPreviewShipment" runat="server" TransferTo="~/SCM/EditShipmentFromReturnedPO.aspx" />
