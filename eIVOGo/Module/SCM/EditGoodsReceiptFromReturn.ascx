...
<uc2:PageAnchor ID="NextAction" runat="server" TransferTo="~/SCM/PreviewGoodsReceiptFromReturn.aspx" />
<uc2:PageAnchor ID="PreviousAction" runat="server" TransferTo="~/SCM/WarehouseWarrantManagementFromReturn.aspx" />
