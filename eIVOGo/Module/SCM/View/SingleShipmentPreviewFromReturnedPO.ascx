<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SingleShipmentPreviewFromReturnedPO.ascx.cs"
    Inherits="eIVOGo.Module.SCM.View.SingleShipmentPreviewFromReturnedPO" %>
...
<uc3:DataModelContainer ID="modelItem" runat="server" Suffix=".ReturnedPO" />
