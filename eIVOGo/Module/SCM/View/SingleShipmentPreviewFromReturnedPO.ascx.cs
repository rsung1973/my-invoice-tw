...
{
    public partial class SingleShipmentPreviewFromReturnedPO : SCMEntityPreview<CDS_Document>
    {
        ...
        public override void PrepareDataFromDB(object keyValue)
        {
            ...
            returnedPODetails.Items = _item.PURCHASE_ORDER_RETURNED.PURCHASE_ORDER_RETURNED_DETAILS;
        }
        ...
        protected override void prepareDataForViewState()
        {
            ...
            {
                var returnedItem = dsEntity.CreateDataManager().GetTable<PURCHASE_ORDER_RETURNED>().Where(b => b.PURCHASE_ORDER_RETURNED_SN == _item.DocID).First();
                _item.PURCHASE_ORDER_RETURNED = returnedItem;
                ...
                returnedPODetails.Items = returnedItem.PURCHASE_ORDER_RETURNED_DETAILS;
            }
        }
    }
}