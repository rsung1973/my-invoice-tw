<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SingleShipmentPreview.ascx.cs"
    Inherits="eIVOGo.Module.SCM.View.SingleShipmentPreview" %>
...
<uc3:DataModelContainer ID="modelItem" runat="server" Suffix=".BO" />
