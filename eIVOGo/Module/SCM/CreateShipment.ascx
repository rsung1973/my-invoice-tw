<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreateShipment.ascx.cs"
    Inherits="eIVOGo.Module.SCM.CreateShipment" %>
...
<%@ Register src="Item/BODetailsListForShipment.ascx" tagname="BODetailsListForShipment" tagprefix="uc5" %>
    ...
    <table class="left_title" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
            <tr>
                ...
                <td class="tdleft">
                    <%# _item.BUYER_ORDERS.WAREHOUSE.WAREHOUSE_NAME %>
                </td>
            </tr>
            <tr>
                <th width="20%">
...
<uc4:DeliveryCompanySelectorView ID="delivery" 
        runat="server" />
<uc5:BODetailsListForShipment ID="boDetails" runat="server" />
...
<uc6:PageAnchor ID="ToPreviewShipment" runat="server" TransferTo="~/SCM/PreviewShipment.aspx" />
