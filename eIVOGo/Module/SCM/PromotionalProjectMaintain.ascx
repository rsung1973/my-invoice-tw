<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PromotionalProjectMaintain.ascx.cs"
    Inherits="eIVOGo.Module.SCM.PromotionalProjectMaintain" %>
...
<%@ Register src="View/SalesPromotionList.ascx" tagname="SalesPromotionList" tagprefix="uc4" %>
...
<!--路徑名稱-->
<uc5:PageAction ID="actionItem" runat="server" ItemName="首頁 > 促銷專案維護" />
<!--交易畫面標題-->
<uc6:FunctionTitleBar ID="titleBar" runat="server" ItemName="促銷專案維護" />
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="top_table">
    <tr>
        <td>
            <asp:Button ID="btnAdd" runat="server" Text="新增促銷專案" class="btn" OnClick="btnAdd_Click" />
        </td>
    </tr>
</table>
<div id="border_gray">
...
<uc4:SalesPromotionList ID="itemList" runat="server" Visible="false" />
<uc8:DataModelContainer ID="modelItem" runat="server" />
<uc7:PageAnchor ID="ToAddSalesPromo" runat="server" TransferTo="~/SCM_SYSTEM/Promotional_Project_Maintain_Add.aspx" />
