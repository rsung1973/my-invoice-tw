...
{
    public partial class CreateShipment : System.Web.UI.UserControl
    {
        ...
        protected virtual void singleShipment_Load(object sender, EventArgs e)
        {
            ...
            _item.BUYER_ORDERS = dsEntity.CreateDataManager().EntityList.Where(b => b.BUYER_ORDERS_SN == _item.DocID).First();
