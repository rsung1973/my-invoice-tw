...
{
    public partial class CreateShipmentFromReturnedPO : System.Web.UI.UserControl
    {
        ...
        protected virtual void singleShipment_Load(object sender, EventArgs e)
        {
            ...
            var returnedPOItem = dsEntity.CreateDataManager().EntityList.Where(b => b.PURCHASE_ORDER_RETURNED_SN == _item.DocID).First();
            _item.PURCHASE_ORDER_RETURNED = returnedPOItem;
            returnedPODetails.Items = returnedPOItem.PURCHASE_ORDER_RETURNED_DETAILS;
        }
