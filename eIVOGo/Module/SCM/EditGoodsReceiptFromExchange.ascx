<%@ Control Language="C#" AutoEventWireup="true" Inherits="eIVOGo.Module.SCM.EditGoodsReceiptFromPO" %>
...
<uc2:PageAnchor ID="NextAction" runat="server" TransferTo="~/SCM/PreviewGoodsReceiptFromExchange.aspx" />
<uc2:PageAnchor ID="PreviousAction" runat="server" TransferTo="~/SCM/WarehouseWarrantManagementFromExchange.aspx" />
