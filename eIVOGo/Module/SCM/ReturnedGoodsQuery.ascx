<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReturnedGoodsQuery.ascx.cs"
    Inherits="eIVOGo.Module.SCM.ReturnedGoodsQuery" %>
...
<%@ Register Src="View/ReturnedGoodsList.ascx" TagName="ReturnedGoodsList" TagPrefix="uc14" %>
...
<!--路徑名稱-->
<uc5:PageAction ID="actionItem" runat="server" ItemName="首頁 &gt; 退貨作業" />
<!--交易畫面標題-->
<uc6:FunctionTitleBar ID="titleBar" runat="server" ItemName="退貨作業" />
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="top_table">
    <tr>
        <td>
            <asp:button id="btnAdd" runat="server" text="新增退貨單" class="btn" onclick="btnAdd_Click" />
        </td>
    </tr>
</table>
    ...
    <table class="left_title" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:textbox id="orderNo" runat="server" text='<%# _item.GOODS_RETURNED_NUMBER %>'> </asp:textbox>
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList id="returnStatus" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
...
<uc14:ReturnedGoodsList ID="itemList" runat="server" Visible="false" />
...
<uc13:PageAnchor ID="ToCreateReturnedGoods" runat="server" TransferTo="~/SCM/BuyerOrderQueryForReturn.aspx" />
<script runat="server">
