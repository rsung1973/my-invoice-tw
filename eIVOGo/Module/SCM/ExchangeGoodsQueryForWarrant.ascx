<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExchangeGoodsQueryForWarrant.ascx.cs"
    Inherits="eIVOGo.Module.SCM.ExchangeGoodsQueryForWarrant" %>
...
<%@ Register Src="View/ExchangeGoodsListForWarrant.ascx" TagName="ExchangeGoodsListForWarrant" TagPrefix="uc14" %>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="tdleft">
                        ...
                        <asp:ListItem Selected="True" Value="~/SCM/WarehouseWarrantManagementFromExchange.aspx">換貨單</asp:ListItem>
...
<uc14:ExchangeGoodsListForWarrant ID="itemList" runat="server" Visible="false" />
...
<uc13:PageAnchor ID="ToCreateWarrant" runat="server" TransferTo="~/SCM/EditWarrantFromExchange.aspx" />
<script runat="server">
