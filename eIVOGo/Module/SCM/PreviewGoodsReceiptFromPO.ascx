<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PreviewGoodsReceiptFromPO.ascx.cs"
    Inherits="eIVOGo.Module.SCM.PreviewGoodsReceiptFromPO" %>
...
<uc2:PageAnchor ID="PreviousAction" runat="server" TransferTo="~/SCM/EditGoodsReceipt.aspx" />
