...
<tr>
    <td>
        <input class="form-control" name="ItemNo" type="text" /></td>
    <td>
        <input class="form-control" name="Brief" type="text" /></td>
    <td>
        <input class="form-control" name="UnitCost" type="text" /></td>
    <td>
        <input class="form-control" name="Piece" type="text" /></td>
    <td>
        <input class="form-control" name="CostAmount" type="text" /></td>
    <td>
