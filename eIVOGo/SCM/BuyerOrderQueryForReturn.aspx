...
<%@ Register src="../Module/SCM/BuyerOrderQueryToReturn.ascx" tagname="BuyerOrderQueryToReturn" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <uc1:BuyerOrderQueryToReturn ID="BuyerOrderQueryToReturn1" runat="server" />
</asp:Content>
