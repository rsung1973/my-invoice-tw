...
<%@ Register src="../Module/SCM/PreviewReturnedGoods.ascx" tagname="PreviewReturnedGoods" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <uc1:PreviewReturnedGoods ID="PreviewReturnedGoods1" runat="server" />
    </asp:Content>
