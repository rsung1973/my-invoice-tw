...
<%@ Register src="../Module/SCM/POReturnedQueryForShipment.ascx" tagname="POReturnedQueryForShipment" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <uc1:POReturnedQueryForShipment ID="POReturnedQueryForShipment1" 
        runat="server" />
</asp:Content>
