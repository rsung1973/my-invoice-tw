...
<%@ Register src="../Module/SCM/BuyerOrderQueryForShipment.ascx" tagname="BuyerOrderQueryForShipment" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <uc1:BuyerOrderQueryForShipment ID="BuyerOrderQueryForShipment1" 
        runat="server" />
</asp:Content>
