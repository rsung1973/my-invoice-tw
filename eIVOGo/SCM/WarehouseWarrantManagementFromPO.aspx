...
<%@ Register src="../Module/SCM/MaintainGoodsReceiptFromPO.ascx" tagname="MaintainGoodsReceiptFromPO" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <uc1:MaintainGoodsReceiptFromPO ID="MaintainGoodsReceiptFromPO1" 
        runat="server" />
</asp:Content>
