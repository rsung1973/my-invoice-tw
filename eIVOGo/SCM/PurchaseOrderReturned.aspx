...
<%@ Register src="../Module/SCM/PurchaseOrderReturned.ascx" tagname="PurchaseOrderReturned" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <uc1:PurchaseOrderReturned ID="PurchaseOrderReturned1" runat="server" />
</asp:Content>
