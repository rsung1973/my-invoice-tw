...
<%@ Register src="../Module/SCM/EditGoodsReceiptFromPO.ascx" tagname="EditGoodsReceiptFromPO" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <uc1:EditGoodsReceiptFromPO ID="EditGoodsReceiptFromPO1" runat="server" />
</asp:Content>
