...
<%@ Register src="../Module/SCM/PurchaseOrderVerify.ascx" tagname="PurchaseOrderVerify" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <uc1:PurchaseOrderVerify ID="PurchaseOrderVerify1" runat="server" />
</asp:Content>
