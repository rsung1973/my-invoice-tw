...
<body>
    ...
    <p>
        ...
        發票號碼：<span class="blue"><%# _item.TrackCode %><%# _item.No %></span>，依據財政部所公告統一發票中獎號碼，確認您的發票已中獎，中獎發票將以掛號寄出，郵寄收件人資料如下：</p>
    <p>
        收件人：<span class="blue"><%# SharedFunction.StringMask(_item.InvoiceBuyer.ContactName,2,1,'*') %></span></p>
    <p>
