...
<%@ Register src="../Module/SCM/CreateExchangeGoods.ascx" tagname="CreateExchangeGoods" tagprefix="uc1" %>
...
<body>
    ...
    <uc1:CreateExchangeGoods ID="CreateExchangeGoods1" runat="server" />
    </form>
</body>
</html>
<script runat="server">
