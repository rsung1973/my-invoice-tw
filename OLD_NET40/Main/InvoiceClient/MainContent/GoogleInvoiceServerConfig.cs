...
{
    public partial class GoogleInvoiceServerConfig : UserControl , ITabWorkItem
    {
        private ServerInspector _inspector;

        public GoogleInvoiceServerConfig()
        {
            InitializeComponent();
            _inspector = InvoiceClientTransferManager.GetServerInspector(typeof(InvoicePDFInspector));
        }
