...
namespace DataAccessLayer.basis
{
	...
	public class ModalUtility
	{
		...
		public static SqlCommand InvokeStoredProcedure(string spName,SqlConnection conn)
		{
		...
		public static SqlCommand InvokeStoredProcedure(string spName,SqlConnection conn,object uid)
		{
			SqlCommand sqlCmd = InvokeStoredProcedure(spName,conn);
			sqlCmd.Parameters["@UID"].Value = uid;
			return sqlCmd;
		}

		public static SqlCommand InvokeStoredProcedure(string spName,SqlConnection conn,string orderBy)
		{
			SqlCommand sqlCmd = InvokeStoredProcedure(spName,conn);
		...
		public static void AssignCommandParameter(SqlCommand sqlCmd,DataRow row)
		{
			SqlParameterCollection cmdParams = sqlCmd.Parameters;
		...
		public static void AssignCommandParameter(SqlCommand sqlCmd,object[] param)
		{
			SqlParameterCollection cmdParams = sqlCmd.Parameters;
			for(int i=0;i<cmdParams.Count-1 && i<param.Length;i++)
			{
				cmdParams[i+1].Value = param[i];
			}
		}


		public static void AssignCommandParameter(SqlCommand sqlCmd,IDataReader dr)
		{
			SqlParameterCollection cmdParams = sqlCmd.Parameters;
		...
		{
            XmlElement element;
            return AppendResultSet(table, dr, out element);
		}


        public static XmlDocument AppendResultSet(XmlNode table, IDataReader dr,out XmlElement element)
        {
		...
		public static void AssignCommandParameter(SqlCommand sqlCmd,IDictionary param)
		{
			SqlParameterCollection cmdParams = sqlCmd.Parameters;
			string paramName;
